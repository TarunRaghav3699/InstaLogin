...
const Search = () => {
  ...
  const controller = (e, hook) => {
    ...
    if (hook === "onFocus") modelOnFocus(elements);
    else if (hook === "onBlur") modelOnBlur(elements);
  };
  ...
  return (
    <div className="Navigation">
      ...
      <img
        ...
        src="https://raw.githubusercontent.com/xlerida/instagram-ui/master/src/assets/IDPXr2NY_400x400.jpg"
        alt="Profile"
      ></img>
    </div>
  );
...
const Main = () => {
  return (
    <main className="Main" activescreen="Home">
      <Home />
    </main>
  );
};
...
const Stories = () => {
  ...
  const modelOnLoad = (data) => {
    if (data.status === "new") viewStoryNew(data);
    else viewStorySeen(data);
  };
  ...
  const modelArrowClick = (arrow) => {
    if (arrow === "Left") viewScrollLeft();
    else viewScrollRight();
  };
                  ...
                  <svg width="66" height="66" viewBox="0 0 100 100">
                    <defs>
                      <linearGradient
                        ...
                        y2="100%"
                      >
                        <stop offset="0%" className="gradientOne" />
                        <stop offset="100%" className="gradientTwo" />
                      </linearGradient>
                    </defs>
                    <circle
                      cx="50"
        ...
        return (
          <article className="Post" key={post.id}>
            <div className="Header">
              <div className="UserInfo">
                <div
                  ...
                  alt="User"
                ></div>
                <a href="#d">{post.author.username}</a>
              </div>
            ...
            <div className="PostActivity">
              ...
              <p className="LikedBy">
                Liked by{" "}
                <a className="User" href="#d">
                  {post.likedBy}
                </a>{" "}
                and <span>others</span>
              </p>
              ...
              <div className="LastComments">
                {post.comments.map((comment) => {
                  return (
                    <div className="LastComment" key={comment.id}>
                      <p className="Comment">
                        <a className="User" href="#d">
                          {comment.author}
                        </a>{" "}
...
const Profile = () => {
  return (
    <article className="MyProfile">
      ...
      <div>
        <p className="Action">{user.action}</p>
      </div>
    </article>
  );
};
          ...
          <div className="Suggestion" key={suggestion.id}>
            <div className="Image_User_Name">
              ...
              <div className="User_Name">
                ...
                <p className="Name">{suggestion.description}</p>
              </div>
            </div>
